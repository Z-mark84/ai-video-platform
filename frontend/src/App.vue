...
const currentModule = ref<'pipeline' | 'm1' | 'm2' | 'm3' | 'm4' | 'm5' | 'm6' | 'm7' | 'm8'>('pipeline')

const menuOptions = [
  { label: () => '🎬 视频生成', key: 'pipeline', icon: () => '🎬' },
  ...
  <NConfigProvider :theme="darkTheme">
    <NMessageProvider>
      <div class="app-container">
        ...
        <main class="app-main">
          <PipelinePanel v-if="currentModule === 'pipeline'" />
          <DualChannelInput v-else-if="currentModule === 'm1'" />
        ...
        <footer class="app-footer">
          <span>v0.4.0</span>
          <span>🎬 Pipeline · 视频生成 · Demo 模式</span>
        </footer>
      </div>
    </NMessageProvider>
  </NConfigProvider>
